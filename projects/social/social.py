...
class SocialGraph:
    ...
    def add_friendship(self, user_id, friend_id):
        ...
        # Checks if target is already friends with self
        elif friend_id in self.friendships[user_id] or user_id in self.friendships[friend_id]:
            print("WARNING: Friendship already exists")
        # If not creates a two way edge between nodes (friendship)
        else:
    ...
    def add_user(self, name):
        ...
        self.last_id += 1
        # Assigns a name to this new user
        self.users[self.last_id] = User(name)
        # Creates an empty set to house this users friends
    ...
    def get_all_social_paths(self, user_id):
        ...
        while q.size() > 0:
            ...
            if friend not in visited:
                ...
                visited[friend] = path
                # print("Not in visited:", self.friendships[friend])
